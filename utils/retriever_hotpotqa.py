...
validation_data=[]
N_validation=hotpot_qa["validation"].num_rows
progress_bar=tqdm(range(N_validation))
for i in range(N_validation):
    validation_data.append({})
    validation_data[-1]["id"]=i
    validation_data[-1]["question"]=hotpot_qa["validation"][i]["question"]
    validation_data[-1]["answers"]=hotpot_qa["validation"][i]["answer"]

...
We also extracts the input query for the retrieving contexts from corpus. This script is different
from the original because it extracts crafts the retreiving input query using 2 pass inference that is 

qn -> LLM1 -> ans1
qn -> LLM2 -> ans2, context

retrieval query : qn + ans1 + context

LLM1 : lora finetuned for ans generation
LLM2 : lora finetuned for ans + context generation
"""
